...
// 
//  This file is part of Dapplo.logSource.Facade
// 
//  Dapplo.logSource.Facade is free software: you can redistribute it and/or modify
//  it under the terms of the GNU Lesser General Public License as published by
//  the Free Software Foundation, either version 3 of the License, or
//  (at your option) any later version.
// 
//  Dapplo.logSource.Facade is distributed in the hope that it will be useful,
//  but WITHOUT ANY WARRANTY; without even the implied warranty of
//  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
//  GNU Lesser General Public License for more details.
// 
//  You should have a copy of the GNU Lesser General Public License
//  along with Dapplo.logSource.Facade. If not, see <http://www.gnu.org/licenses/lgpl.txt>.
...
namespace Dapplo.Log.Tests
{
	public static class LoggerTestSupport
	{
		...
		public static void TestAllLogMethods(ILogger loggerUnderTest)
		{
			...
			LogSettings.RegisterLoggerFor(logSource, loggerUnderTest);
			try
			{
			...
			{
				LogSettings.DeregisterLoggerFor(logSource, loggerUnderTest);
			}
		}
